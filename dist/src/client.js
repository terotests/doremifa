...
var testComponent = /** @class */ (function (_super) {
    ...
    testComponent.prototype.render = function () {
        ...
        return index_1.drmf(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n    <div style=", ">\n      ", "\n      <div>", "</div>\n      <div>", "</div>\n      <div><textarea class=\"foobar\"/></div>\n      <h1 click=", ">Hello ", "</h1>\n      \n      <div> \n        <div>Swap 1</div>\n        ", "\n      </div>\n      <div> \n        <div>Swap 2</div>\n        ", "\n      </div>\n\n      <div> \n        <div>Swap 3</div>\n        ", "\n      </div>      \n\n      ", "\n    </div>\n    "], ["\n    <div style=", ">\n      ", "\n      <div>", "</div>\n      <div>", "</div>\n      <div><textarea class=\"foobar\"/></div>\n      <h1 click=",
            ">Hello ", "</h1>\n      \n      <div> \n        <div>Swap 1</div>\n        ", "\n      </div>\n      <div> \n        <div>Swap 2</div>\n        ", "\n      </div>\n\n      <div> \n        <div>Swap 3</div>\n        ", "\n      </div>      \n\n      ",
            "\n    </div>\n    "])), "position:absolute;left:" + (i * 50 + '') + "px;top:" + i * 450 + "px;", myHelloComponent, 0, index_1.getState().time ? index_1.getState().time.toString() : '', function (e) {
            console.log('round ', i);
...
var HelloWorld = /** @class */ (function (_super) {
    ...
    HelloWorld.prototype.render = function () {
        ...
        return index_1.html(templateObject_9 || (templateObject_9 = __makeTemplateObject(["<div>\n      <h4>Hello World, it is ", "</h4>\n\n        ", "\n\n        <div class=\"collection\">\n          ", "\n        </div>  \n      </div>\n    \n    "], ["<div>\n      <h4>Hello World, it is ", "</h4>\n\n        ",
            ...
            test: function (_) { return index_1.html(templateObject_11 || (templateObject_11 = __makeTemplateObject(["<div>Test Page\n                ", "\n            </div>"], ["<div>Test Page\n                ", "\n            </div>"])), myHelloComponent4); }
        }), links.map(function (item) { return index_1.html(templateObject_12 || (templateObject_12 = __makeTemplateObject(["<a href=\"#test/", "\" class=\"collection-item\">Item ", "</a>"], ["<a href=\"#test/", "\" class=\"collection-item\">Item ", "</a>"])), item, item); }));
    };
    return HelloWorld;
}(index_1.drmfComponent));
exports.HelloWorld = HelloWorld;
index_1.mount(document.body, new HelloWorld());
timers_1.setInterval(function () {
    index_1.setState({ time: new Date() });
}, 100);
var templateObject_1, templateObject_2, templateObject_4, templateObject_5, templateObject_6, templateObject_8, templateObject_7, templateObject_3, templateObject_10, templateObject_11, templateObject_12, templateObject_9;
